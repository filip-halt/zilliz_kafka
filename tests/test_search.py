...
from milvuskafka.datatypes import MilvusDocument, MilvusSearchRequest, MilvusSearchResponse
...
def test_input(runner_and_producer_consumer: Tuple[MilvusSearch, Producer, Consumer]):
    r, producer, consumer = runner_and_producer_consumer
    r.milvus_client.insert(values.MILVUS_COLLECTION, data=[{"chunk_id": "1", "doc_id": "1", "chunk": "123", "embedding": [0,0,0]}])
